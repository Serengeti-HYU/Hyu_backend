...
public class RestController {
    ...
    public ResponseEntity<String> getCulturalEventInfo(
            ...
            @RequestParam(value="end_index", defaultValue = "10") Integer endIndex,
        ...
        try {
            // URL 생성
            String urlStr = UriComponentsBuilder.fromHttpUrl(apiUrl + key + type + serviceName + "/" + startIndex + "/" + endIndex)
                    .queryParamIfPresent("CODENAME", Optional.ofNullable(codename))
